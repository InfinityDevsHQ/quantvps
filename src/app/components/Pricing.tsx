...
const PricingCard = ({
  ...
  return (
    <div
      ...
      className={`btn relative flex flex-col rounded-lg bg-neutral-900 bg-card px-6 py-4 text-left shadow ${
    ...
    >
      ...
      <ul
        className={`my-6 flex-1 text-center transition-all duration-300 ease-in-out ${
